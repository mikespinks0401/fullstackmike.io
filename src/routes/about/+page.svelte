			...
			<div class="mb-12 px-4 lg:px-0">
				...
				<div class="py-12">
					...
					<p>
						...
						drawn to the backend, as it is where the business logic is implemented.However, I welcome and enjoy working through the challenges that come from either part of the stack. The end goal is never to simply get the necessary answer; it will always be to gain understanding.
					</p>
					<p>
					...
					<p>
						...
						others succeed. I hope to inspire and assist those that are crazy enough to take this serous. This journey has been one hell of a ride, but I wouldn't trade it for the world.
					</p>
				</div>
			</div>
		</section>
